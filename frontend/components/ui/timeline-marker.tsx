...
export function TimelineMarker({ isLast = false, isFirst = false, type = 'mood', avatar, userName = '' }: TimelineMarkerProps) {
  const iconName = 
  ...
  const initials = userName
    ...
    <View className="flex-col items-center relative">
      {/* The avatar sits in front of the timeline as a "node" */}
      <View className={cn(
