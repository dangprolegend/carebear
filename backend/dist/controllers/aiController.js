...
exports.suggestTasksFromInput = void 0;
const ocrService_1 = require("../services/ocrService");
const llmService_1 = require("../services/llmService");
const suggestTasksFromInput = async (req, res) => {
    try {
        ...
        if (image_base64) {
            try {
                const base64Data = image_base64.startsWith('data:')
                    ...
                    : image_base64;
                const ocrText = await (0, ocrService_1.getTextFromImage)(base64Data);
      ...
      """
    `;
        const suggestions = await (0, llmService_1.generateTaskSuggestions)(llmPrompt);
...
exports.suggestTasksFromInput = suggestTasksFromInput;
